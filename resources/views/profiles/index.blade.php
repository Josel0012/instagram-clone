    ...
    <div class="container profile">
        <div class="row">
            <div class="col-md-3 p-5 d-flex justify-content-center">
                <img src="{{ $user->profile->profileImage() }}" alt="" style="" class="dp img-fluid rounded-circle">
            </div>
        ...
        <div class="row pt-5">
            ...
            @foreach ($user->posts as $post)
                <div class="col-4 pb-4">
                    <a href="/p/{{ $post->id }}">
                        <img src="/storage/uploads/{{ $post->image }}" alt="" class="w-100">
                    </a>
                </div>
            @endforeach
